...
export default function BasicTable() {
  ...
  React.useEffect(() => {
    ...
    fetch("http://localhost:5000/api/reviews/displayReview", requestOptions)
  ...
  return (
    <div style={{ marginLeft: "20px", marginRight: "20px", marginTop: "20px" }}>
            ...
            {data?.map((row) => (
              ...
              >
                ...
                <TableCell align="right">
                  <Stack spacing={1}>
                    <Rating name="size-large" defaultValue={row.ratings} size="large" />
                  </Stack>
                </TableCell>
              </TableRow>
            ))}
      ...
      <p>Wanna add review? <Button variant="contained" onClick={handleClick}>Add Review</Button></p>
    </div>
  );
}
